  ...
  return (
    <Card className="h-full flex flex-col">
      ...
      <CardContent className="flex-grow overflow-hidden">
        {contract.analysisProtocol && contract.analysisProtocol.length > 0 ? (
        ...
        <Tabs defaultValue="klauseln" className="p-6" value={activeTab} onValueChange={setActiveTab}>
          ...
          <TabsContent value="klauseln" className="space-y-6">
            <div className="rounded-lg border shadow-sm">
              <div className="divide-y">
                {contract.analysisProtocol.map((clause) => (
                  <Collapsible
                    key={clause.id}
