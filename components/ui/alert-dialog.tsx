...
const AlertDialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 border-b border-border/60 pb-4 text-center sm:text-left",
      className
    )}
    {...props}
  />
...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse gap-2 pt-4 sm:flex-row sm:justify-end sm:space-x-2 sm:gap-0 border-t border-border/60",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(buttonVariants({ variant: "brand_gradient" }), "font-semibold", className)}
    {...props}
  />
))
